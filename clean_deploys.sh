...
#kubectl delete deployments,pods --all -n cicd
#kubectl delete secrets,sa,configmaps,services,deployments,pods,ingresses,clusterroles,clusterrolebindings,customresourcedefinition,serviceaccounts
#kubeadm reset
#rm -Rf /var/lib/etcd
